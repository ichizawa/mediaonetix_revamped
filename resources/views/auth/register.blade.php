                ...
                <div
                    ...
                    <form class="relative space-y-6" action="{{ route('register.post') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                <label for="password"
                                    class="block text-sm font-semibold text-gray-300 mb-2">Password <span class="text-red-400">*</span></label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                ...
                                <label class="relative cursor-pointer">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-400 rounded-lg flex items-center justify-center flex-shrink-0">
                        ...
                        <div class="form-group">
                            <label class="flex items-start gap-3 cursor-pointer group">
                                <input type="checkbox"
                                    class="mt-1 w-4 h-4 rounded border-gray-600 bg-white/5 text-blue-500 focus:ring-blue-500/20 focus:ring-offset-0"
                                    required>
                                <span class="text-sm text-gray-400 group-hover:text-gray-300 transition-colors">
                                    I agree to the <a href="#" class="text-blue-400 hover:text-blue-300 font-medium">Terms
                                        ...
                                        class="text-blue-400 hover:text-blue-300 font-medium">Privacy Policy</a>
                                </span>
                            </label>
                        </div>
