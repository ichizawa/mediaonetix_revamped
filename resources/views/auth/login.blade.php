    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0c1222]">
        ...
        <div class="relative container mx-auto px-4 sm:px-6 lg:px-12 py-12">
            <div class="max-w-md mx-auto">
                ...
                <!-- Login Card -->
                <div class="login-card relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl border border-white/10 rounded-2xl p-8 glow-effect">
                    ...
                    <form class="relative space-y-6">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <label class="flex items-center gap-2 cursor-pointer group">
                                <input type="checkbox" class="w-4 h-4 rounded border-gray-600 bg-white/5 text-blue-500 focus:ring-blue-500/20 focus:ring-offset-0">
                                <span class="text-gray-400 group-hover:text-gray-300 transition-colors">Remember me</span>
                            </label>
                            <a href="#" class="text-blue-400 hover:text-blue-300 transition-colors font-medium">Forgot password?</a>
                        </div>
                ...
                <div class="text-center mt-8 text-sm text-gray-500">
                    <p>By signing in, you agree to our <a href="#" class="text-gray-400 hover:text-gray-300 transition-colors">Terms of Service</a> and <a href="#" class="text-gray-400 hover:text-gray-300 transition-colors">Privacy Policy</a></p>
                </div>
            </div>
        </div>
    </section>
