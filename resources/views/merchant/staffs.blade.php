...
@section('content')
                            ...
                            <tbody class="divide-y divide-white/10">
                                ...
                                <tr class="hover:bg-white/5 transition-all">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-10 h-10 bg-gradient-to-br from-purple-600 to-purple-400 rounded-full flex items-center justify-center text-white font-semibold">
                                                SJ
                                            </div>
                                            <div>
                                    ...
                                    <td class="px-6 py-4">
                                        <span
                                            class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-purple-500/10 text-purple-400">
                                            Manager
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="hover:bg-white/5 transition-all">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-10 h-10 bg-gradient-to-br from-green-600 to-green-400 rounded-full flex items-center justify-center text-white font-semibold">
                                                MW
                                            </div>
                                            <div>
                                    ...
                                    <td class="px-6 py-4">
                                        <span
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-gray-500/10 text-gray-400">
                                            Inactive
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="hover:bg-white/5 transition-all">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-10 h-10 bg-gradient-to-br from-orange-600 to-orange-400 rounded-full flex items-center justify-center text-white font-semibold">
                                                EB
                                            </div>
                                            <div>
    ...
    <div id="addStaffModal" class="modal">
        <div
            ...
            <form class="p-6 space-y-6" id="staffForm" action="{{ route('merchant.staffs.store') }}" method="POST"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="text"
                                    class="flex-1 px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500/50"
                                    placeholder="Auto-generated" readonly>
                                <button type="button"
                                    class="px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white hover:bg-white/10 transition-all">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        ...
        addStaffBtn.addEventListener('click', () => {
            ...
            if (categoryLabel) categoryLabel.textContent = categoryLabel.getAttribute('data-default-text') ||
                'Category';
