...
<div id="eventModal" class="modal">
    <div
        ...
        <form id="eventForm" action="{{ route('merchant.events.store') }}" method="POST" class="space-y-4"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="custom-select-wrapper" data-target="eventCategory" style="position:relative">
                        <button type="button"
                            class="custom-select-btn w-full px-4 py-2 border border-white/10 rounded-lg text-white text-left flex justify-between items-center focus:outline-none focus:border-blue-500"
                            style="background-color:#1a2332">
                            <span class="custom-select-label">Music</span>
                        ...
                        <div class="custom-select-dropdown hidden border border-white/10 rounded-lg overflow-hidden shadow-xl"
                            style="position:absolute; top:100%; margin-top:4px; width:100%; z-index:999; background-color:#1a2332;">
                            <div class="custom-select-option px-4 py-2 text-white hover:bg-blue-600/30 cursor-pointer"
            ...
            <div>
                ...
                <div class="custom-select-wrapper" data-target="eventStatus" style="position:relative">
                    <button type="button"
                        class="custom-select-btn w-full px-4 py-2 bg-[#1a2332] border border-white/10 rounded-lg text-white text-left flex justify-between items-center focus:outline-none focus:border-blue-500">
                        <span class="custom-select-label">Upcoming</span>
                        <svg class="w-4 h-4 text-gray-400 transition-transform" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <div class="custom-select-dropdown hidden border border-white/10 rounded-lg overflow-hidden shadow-xl"
                        ...
                        <div class="custom-select-option px-4 py-2 hover:bg-white/5 cursor-pointer font-medium"
                            data-value="0" style="color:#c084fc">Upcoming</div>
                        <div class="custom-select-option px-4 py-2 hover:bg-white/5 cursor-pointer font-medium flex items-center gap-2"
