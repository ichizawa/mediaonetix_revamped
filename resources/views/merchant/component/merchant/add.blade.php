...
<div id="addMerchantModal" class="fixed inset-0 z-[9999] hidden" style="display: none;">
    <div class="flex items-center justify-center min-h-screen px-4 py-8">
        <!-- Background overlay -->
        <div class="fixed inset-0 bg-black/80 backdrop-blur-sm transition-opacity" onclick="closeAddMerchantModal()">
        </div>
        ...
        <div class="relative bg-[#1a1f35] rounded-2xl shadow-2xl w-full max-w-4xl border border-white/10 my-8 opacity-0 transform scale-95 transition-all duration-200"
            ...
            <!-- Modal Body -->
            <form id="addMerchantForm" class="p-6 max-h-[calc(100vh-200px)] overflow-y-auto"
                action="{{ route('admin.merchants.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
