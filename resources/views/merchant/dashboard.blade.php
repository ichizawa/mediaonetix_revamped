            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <button
                            class="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-blue-600/20 to-blue-400/10 border border-blue-500/30 rounded-xl hover:border-blue-500/50 transition-all group" onclick="window.location.href='{{ route('merchant.events') }}?add=1'">
                            <div
                        ...
                        <button
                            ...
                            onclick="window.location.href='{{ route('merchant.sales') }}?add=1'">
                            <div
                        ...
                        <button
                            class="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-purple-600/20 to-purple-400/10 border border-purple-500/30 rounded-xl hover:border-purple-500/50 transition-all group"
                            onclick="window.location.href='{{ route('merchant.organizers') }}?add=1'">
                            ...
                            <span class="text-white font-semibold">Add Staffs</span>
                        </button>
                    </div>
                </div>
            </div>
