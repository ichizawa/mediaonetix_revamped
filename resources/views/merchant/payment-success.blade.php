    ...
    <div class="page">
        ...
        <div class="success-icon-wrap fade-up">
            <div class="success-icon-ring">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.2" stroke-linecap="round"
            ...
            <div class="card fade-up fade-up--d2">
                ...
                <div class="order-rows">
                    ...
                    <div class="order-row">
                        ...
                        <span class="order-row__val">{{ $orderSummary['quantity'] }}
                            {{ Str::plural('ticket', $orderSummary['quantity']) }}</span>
                    </div>
                    ...
                    <div class="order-row">
                        ...
                        <span class="order-row__val"
                            style="font-size:.8rem; color:var(--accent);">{{ $orderSummary['customer_email'] }}</span>
                    </div>
                </div>
                ...
                <!-- CTAs -->
                <div class="cta-wrap">
                    <a href="{{ route('merchant.sales') }}" class="btn-primary">
                    ...
                    <a href="{{ route('merchant.events') }}" class="btn-ghost">
        ...
        @else
            ...
            <div class="cta-wrap fade-up fade-up--d3" style="width:100%;max-width:340px;margin-top:32px;">
                ...
                <a href="{{ route('merchant.events') }}" class="btn-ghost">Browse More Events</a>
            </div>
        @endif
