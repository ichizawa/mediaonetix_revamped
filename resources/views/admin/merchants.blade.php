...
@section('content')
                            ...
                            <tbody>
                                @forelse($users as $merchant)
                                    <tr class="border-b border-white/5 hover:bg-white/5 transition-all">
                                        ...
                                        <td class="py-4 px-4">
                                            <span class="text-white text-sm">{{ $merchant['first_name'] }}
                                                {{ $merchant['last_name'] }}</span>
                                        </td>
                                        <td class="py-4 px-4">
                                        ...
                                        <td class="py-4 px-4">
                                            <span
                                                ...
                                                <span
                                                    class="w-1.5 h-1.5 bg-{{ $merchant->status['color'] }}-400 rounded-full mr-1.5"></span>
                                                {{ $merchant->status['label'] }}
                                            </span>
                                        </td>
                                        <td class="py-4 px-4">
                                            <div class="flex gap-2">
                                                <button onclick="openMerchantModal('{{ $merchant }}')"
                                                ...
                                                <button onclick='openEditMerchantModal(@json($merchant))'
                                                ...
                                                <form id="delete-merchant-form-{{ $merchant['id'] }}"
                                                    action="{{ route('admin.merchants.delete', $merchant['id']) }}"
                                                    method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button"
                                                        onclick="openDeleteMerchantModal('delete-merchant-form-{{ $merchant['id'] }}', '{{ route('admin.merchants.delete', $merchant['id']) }}')"
    ...
    @include('admin.component.merchant.edit')
@endsection
