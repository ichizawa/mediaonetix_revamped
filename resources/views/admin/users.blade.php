                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-400">Manage and monitor all registered users</p>
                            </div>
                        </div>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-white/10">
                                    <th class="text-left py-3 px-4 text-sm font-semibold text-gray-400">User ID</th>
                            ...
                            <tbody>
                                @forelse($users as $user)
                                    <tr class="border-b border-white/5 hover:bg-white/5 transition-all">
                                        ...
                                        <td class="py-4 px-4">
                                            <span class="text-white text-sm">{{ $user['first_name'] }}
                                                {{ $user['last_name'] }}</span>
                                        </td>
                                        <td class="py-4 px-4">
                                        ...
                                        <td class="py-4 px-4">
                                            <span
                                                ...
                                                <span
                                                    class="w-1.5 h-1.5 bg-{{ $user->status['color'] }}-400 rounded-full mr-1.5"></span>
                                                {{ $user->status['label'] }}
                                            </span>
                                        </td>
                                        <td class="py-4 px-4">
