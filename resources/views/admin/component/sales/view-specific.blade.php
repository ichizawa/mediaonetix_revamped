...
@section('content')
        ...
        <div class="lg:ml-64">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <div class="flex items-center gap-2 mb-1">
                                    <a href="{{ route('admin.sales') }}" class="text-sm text-gray-400 hover:text-white transition-colors">Sales</a>
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-white/10 rounded-2xl p-4 sm:p-6">
                    ...
                    <form id="salesFilterForm" method="GET" action="{{ route('admin.sales.edit', ['slug' => $event->slug]) }}">
    ...
    @include('merchant.component.sales.export-modal', [
        'exportPdfRoute' => route('admin.sales.export.pdf', ['event_id' => $event->id]),
        'exportExcelRoute' => route('admin.sales.export.excel', ['event_id' => $event->id]),
    ])
