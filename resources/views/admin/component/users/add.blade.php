<!-- Add User Modal -->
<div id="addUserModal" class="fixed inset-0 z-[9999] hidden" style="display: none;">
    <div class="flex items-center justify-center min-h-screen px-4 py-8">
        <!-- Background overlay -->
        <div class="fixed inset-0 bg-black/80 backdrop-blur-sm transition-opacity" onclick="closeAddUserModal()">
        </div>
        ...
        <div class="relative bg-[#1a1f35] rounded-2xl shadow-2xl w-full max-w-4xl border border-white/10 my-8 opacity-0 transform scale-95 transition-all duration-200"
            ...
            <div class="bg-gradient-to-r from-blue-600/10 to-purple-600/10 px-6 py-4 border-b border-white/10">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-400 mt-1">Fill in the user details below</p>
                    </div>
            ...
            <!-- Modal Body -->
            <form id="addUserForm" class="p-6 max-h-[calc(100vh-200px)] overflow-y-auto"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="role_id" required
                            ...
                            <option value="2" class="text-black">Merchant</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePasswordVisibility('password')"
                                class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-white transition-all">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center gap-4">
                            <div id="imagePreview"
                                class="w-20 h-20 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center text-white text-2xl font-bold overflow-hidden">
                                <svg class="w-10 h-10 text-white/50" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="flex-1">
                                <input type="file" name="image" id="imageInput" accept="image/*"
                                    onchange="previewMerchantImage(event)" class="hidden">
...
<script>
    ...
    // Function to preview user image
