...
@section('content')
    ...
    <div class="min-h-screen bg-[#0c1222]">
        <div class="lg:ml-64">
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                <!-- Event Info Card -->
                <div class="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-white/10 rounded-2xl p-6 mb-8">
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="w-full md:w-48 h-48 bg-gradient-to-br from-blue-600/20 to-purple-600/20 rounded-xl overflow-hidden flex items-center justify-center">
                        ...
                        <div class="flex-1">
                            <h3 class="text-2xl font-bold text-white mb-2">Summer Music Festival 2024</h3>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
                    ...
                    <div class="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                        ...
                        <h3 class="text-3xl font-bold text-white">2,450</h3>
                    </div>
                    <div class="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    @foreach($mockTickets as $ticket)
                        <div class="ticket-card bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden">
                            ...
                            <div class="p-6">
                                <div class="flex items-start justify-between mb-4">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-2 mb-1">
                                            ...
                                            <div class="w-4 h-4 rounded-full border-2 border-white/20" style="background: {{ $ticket['color'] }}"></div>
                                        </div>
                                        <p class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">
                                            ₱{{ number_format($ticket['price'], 2) }}
                                        </p>
                                    </div>
                                    <div class="px-3 py-1 bg-blue-500/20 backdrop-blur-sm border border-blue-500/30 rounded-full">
                                        <span class="text-xs font-semibold text-blue-400">{{ $ticket['quantity'] - $ticket['sold'] }} Available</span>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    <div class="flex justify-between text-sm mb-2">
                                        <span class="text-gray-400">{{ $ticket['sold'] }} / {{ $ticket['quantity'] }} sold</span>
                                        <span class="text-blue-400 font-semibold">{{ round(($ticket['sold'] / $ticket['quantity']) * 100) }}%</span>
                                    </div>
                                    <div class="w-full h-2 bg-gray-700 rounded-full overflow-hidden">
                                        <div class="h-full transition-all"
                                            style="width: {{ round(($ticket['sold'] / $ticket['quantity']) * 100) }}%; background: {{ $ticket['color'] }}"></div>
                                    </div>
                                </div>

                                <div class="flex items-center justify-between pt-4 border-t border-white/10">
                                    <div class="text-sm text-gray-400">
                                        Revenue: <span class="text-white font-semibold">₱{{ number_format($ticket['price'] * $ticket['sold'], 2) }}</span>
                                    </div>
    ...
    <script>
        ...
        // Handle form submission for mockup
        document.getElementById('ticketForm').addEventListener('submit', function(e) {
            e.preventDefault();
            alert('This is a mockup. Form submission would happen here.');
            closeTicketModal();
        });
    </script>
@endsection