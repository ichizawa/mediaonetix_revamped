                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-400">Manage your Profile</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="relative p-8 lg:p-12">
                                ...
                                <div class="mb-8 pb-8 border-b border-blue-500/20">
                                    <h1 class="text-4xl lg:text-5xl font-black text-white mb-2 drop-shadow-lg">My Profile
                                    </h1>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="relative">
                                                    <input type="password"
                                                        class="w-full px-4 py-3 bg-blue-950/30 border-2 border-blue-500/30 rounded-xl text-white placeholder-blue-400/50 focus:border-blue-400 focus:outline-none transition-all duration-300 backdrop-blur-sm pr-12"
                                                        id="security_pin" name="security_pin"
                                                        placeholder="Enter security pin" maxlength="6"
                                                        inputmode="numeric" pattern="[0-9]*">
                                                    <button type="button" id="security-pin-toggle-btn"
                                                        class="absolute right-4 top-1/2 transform -translate-y-1/2 text-blue-400 hover:text-blue-300 transition-colors"
                                                        onclick="toggleSecurityPinVisibility()"
                                                        aria-label="Toggle security pin visibility">
                                                        <i class="bi bi-eye-fill" id="security-pin-toggle-icon"
                                                            style="font-size: 1.2rem;"></i>
                                                    </button>
                                                </div>
                                            </div>
