<div>
    ...
    @if ($event)
        <section
            ...
            <div class="absolute bottom-0 right-0 w-96 h-96 bg-blue-500 rounded-full filter blur-[150px] opacity-10">
            </div>
                            ...
                            <div class="flex flex-col justify-between">
                                <div class="space-y-4 sm:space-y-6">
                                    <div>
                                        <div
                                            ...
                                            <span
                                                class="text-purple-300 text-xs font-semibold">{{ $event->category }}</span>
                                        </div>
                                ...
                                <div
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="text-3xl sm:text-4xl font-black text-purple-400">
                                            ₱{{ number_format($event->tickets_min_price, 2) }}</div>
                                    </div>
                                    <button
                                        class="purchase-btn group w-full lg:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-blue-500 rounded-xl font-bold text-base sm:text-lg shadow-lg hover:shadow-blue-500/50 transition-all hover:scale-105 inline-flex items-center justify-center gap-2 sm:gap-3 text-white"
