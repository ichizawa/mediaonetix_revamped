    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 p-6 space-y-2 overflow-y-auto">
            ...
            @if (auth()->user()->isNotAdmin())
                ...
                @php
                    $prefix = auth()->user()->routePrefix();
                    // Use the correct route name for staff/organizers
                    $staffRoute = $prefix . '.organizers';
                @endphp

                <a href="{{ route($staffRoute) }}"
                    class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ request()->routeIs($prefix . '.organizers*') ? 'bg-blue-500/20 border border-blue-500/30 text-blue-400' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z">
                        </path>
