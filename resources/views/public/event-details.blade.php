...
@section('content')
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero {
    position: relative;
    height: 100svh; min-height: 500px; max-height: 780px;
    overflow: hidden;
  }
  .hero__img {
  ...
  .hero__orb--1 { width: 380px; height: 380px; background: var(--glow-purple); bottom: -60px; left: -80px; animation-delay: 0s; }
  .hero__orb--2 { width: 260px; height: 260px; background: var(--glow-lime);   bottom: 80px; right: 10%;  animation-delay: 3s; animation-direction: alternate-reverse; }
  @keyframes orbFloat {
  ...
  .hero__badge-row { display: flex; gap: 8px; align-items: center; margin-bottom: 20px; flex-wrap: wrap; }
  .hero__badge {
  ...
  .hero__badge-date {
    ...
    color: var(--muted2); background: rgba(255,255,255,.04);
  }
  ...
  .hero__sub {
    ...
    color: var(--muted2); font-weight: 400; letter-spacing: .02em; margin-bottom: 24px;
  }

  .hero__venue-row { display: flex; align-items: center; gap: 10px; }
  .hero__venue-icon {
    width: 32px; height: 32px;
    background: rgba(56,189,248,.12); border: 1px solid rgba(56,189,248,.25);
    border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;
  }
  .hero__venue-name { font-weight: 700; font-size: clamp(1.05rem, 2.5vw, 1.3rem); color: var(--text); }
  .hero__venue-link { font-size: .75rem; color: var(--accent); text-decoration: none; margin-top: 2px; display: block; }
  .hero__venue-link:hover { text-decoration: underline; }
  ...
  /* ─── LAYOUT ─── */
  .wrap { padding: 0 20px 120px; max-width: 720px; margin: 0 auto; }
  ...
  .lineup-scroll {
    ...
    scrollbar-width: none; margin: 0 -20px; padding-left: 20px; padding-right: 20px;
  }
  ...
  .lineup-card.featured { width: 172px; border-color: rgba(56,189,248,.2); }
  ...
  .lineup-card__img { width: 100%; aspect-ratio: 1; object-fit: cover; display: block; }
  .lineup-card__img-placeholder {
    width: 100%; aspect-ratio: 1;
    background: linear-gradient(135deg, #1a1535, #0d0c1a);
    display: flex; align-items: center; justify-content: center;
  }
  .lineup-card__body { padding: 12px 14px 14px; }
  .lineup-card__name { font-weight: 700; font-size: .88rem; color: #fff; margin-bottom: 3px; line-height: 1.2; }
  .lineup-card__role { font-size: .67rem; font-weight: 600; letter-spacing: .07em; text-transform: uppercase; }
  .role--headliner      { color: var(--accent); }
  .role--direct-support { color: var(--pink); }
  .role--opening-act    { color: var(--orange); }
  .lineup-card__desc { font-size: .72rem; color: var(--muted); line-height: 1.5; margin-top: 6px; }
  ...
  .about-text { font-size: .9rem; line-height: 1.8; color: var(--muted2); font-weight: 400; }
  .about-text h1,
  .about-text h2,
  .about-text h3 {
    color: #fff;
  ...
  .show-more-btn {
    ...
    padding: 0; margin-top: 14px; letter-spacing: .02em;
  }
  ...
  .edit-toggle {
    ...
    padding: 4px 12px; cursor: pointer; transition: all .2s; margin-left: auto;
  }
  .edit-toggle:hover { background: rgba(56,189,248,.15); }

  #editor-wrap { display: none; margin-top: 12px; }

  /* ── Quill toolbar ── */
  #editor-wrap .ql-toolbar.ql-snow {
    border: 1px solid var(--rim2); border-bottom: none;
  ...
  #editor-wrap .ql-toolbar .ql-stroke { stroke: var(--muted2) !important; }
  #editor-wrap .ql-toolbar .ql-fill   { fill:   var(--muted2) !important; }
  #editor-wrap .ql-toolbar .ql-thin   { stroke: var(--muted2) !important; }
  /* hover */
  #editor-wrap .ql-toolbar button:hover .ql-stroke,
  #editor-wrap .ql-toolbar .ql-picker-label:hover .ql-stroke { stroke: var(--accent) !important; }
  #editor-wrap .ql-toolbar button:hover .ql-fill,
  #editor-wrap .ql-toolbar .ql-picker-label:hover .ql-fill   { fill:   var(--accent) !important; }
  #editor-wrap .ql-toolbar button:hover,
  #editor-wrap .ql-toolbar .ql-picker-label:hover             { color: var(--accent) !important; }
  /* active/selected */
  #editor-wrap .ql-toolbar button.ql-active .ql-stroke,
  #editor-wrap .ql-toolbar .ql-picker-label.ql-active .ql-stroke,
  #editor-wrap .ql-toolbar .ql-picker-item.ql-selected .ql-stroke { stroke: var(--accent) !important; }
  #editor-wrap .ql-toolbar button.ql-active .ql-fill,
  #editor-wrap .ql-toolbar .ql-picker-label.ql-active .ql-fill   { fill:   var(--accent) !important; }
  #editor-wrap .ql-toolbar button.ql-active,
  #editor-wrap .ql-toolbar .ql-picker-label.ql-active             { color: var(--accent) !important; }
  /* header dropdown */
  #editor-wrap .ql-toolbar .ql-picker-options {
    background: #1e1a38; border: 1px solid var(--rim2) !important;
    border-radius: 8px; box-shadow: 0 8px 24px rgba(0,0,0,.4);
  }
  #editor-wrap .ql-toolbar .ql-picker-item { color: var(--muted2) !important; }
  #editor-wrap .ql-toolbar .ql-picker-item:hover { color: var(--accent) !important; background: rgba(56,189,248,.06); }

  /* ── Quill editor area ── */
  #editor-wrap .ql-container.ql-snow {
    border: 1px solid var(--rim2); border-top: none;
  ...
  #editor-wrap .ql-editor { min-height: 120px; padding: 14px 16px; line-height: 1.75; }
  #editor-wrap .ql-editor.ql-blank::before { color: var(--muted); font-style: normal; left: 16px; }
  /* links inside editor */
  #editor-wrap .ql-editor a { color: var(--accent); }
  /* tooltip/link input */
  #editor-wrap .ql-tooltip {
    background: #1e1a38 !important; border: 1px solid var(--rim2) !important;
    border-radius: 8px; color: var(--text) !important;
    box-shadow: 0 8px 24px rgba(0,0,0,.4);
  }
  #editor-wrap .ql-tooltip input[type=text] {
    background: rgba(255,255,255,.06) !important; border: 1px solid var(--rim2) !important;
    border-radius: 6px; color: var(--text) !important; outline: none;
  }
  #editor-wrap .ql-tooltip a.ql-action,
  #editor-wrap .ql-tooltip a.ql-remove { color: var(--accent) !important; }
  ...
  .rules-card li::before { content: '—'; position: absolute; left: 0; color: var(--accent); font-weight: 700; }

  /* ─── SEAT CHART ─── */
  .seat-chart-wrap {
    position: relative; border-radius: 20px; overflow: hidden;
    cursor: zoom-in; border: 1px solid var(--rim); transition: border-color .2s;
  }
  .seat-chart-wrap:hover { border-color: rgba(56,189,248,.25); }
  .seat-chart-wrap img {
    width: 100%; display: block; max-height: 260px; object-fit: cover;
    filter: brightness(.65) saturate(.8); transition: filter .3s;
  }
  .seat-chart-wrap:hover img { filter: brightness(.8) saturate(1); }
  .seat-chart-overlay {
    position: absolute; inset: 0;
    display: flex; align-items: center; justify-content: center;
  ...
  .seat-chart-label {
    background: rgba(8,7,15,.8); border: 1px solid rgba(255,255,255,.12);
    backdrop-filter: blur(10px); border-radius: 999px;
    padding: 10px 22px; font-size: .78rem; font-weight: 600;
  ...
  .tkt {
    ...
    border-radius: 22px; padding: 22px 24px; cursor: pointer;
  ...
  .tkt:hover { border-color: rgba(var(--tkt-rgb, 56,189,248),.2); }
  .tkt:hover::before { opacity: 1; }
  .tkt.selected {
  ...
  .avail-dot--red    { background: var(--red);    box-shadow: 0 0 7px var(--red); }
  .avail-dot--orange { background: var(--orange); box-shadow: 0 0 7px var(--orange); }
  .avail-dot--green  { background: var(--green);  box-shadow: 0 0 7px var(--green); }
  .avail-dot--gray   { background: var(--muted); }
  .avail--red    { color: var(--red); }
  ...
  .tkt__perks { display: flex; flex-direction: column; gap: 5px; }
  .tkt__perk {
    font-size: .78rem; color: var(--muted2); line-height: 1.5;
  }

  .tkt__stepper-row {
    display: none; align-items: center; justify-content: space-between;
    margin-top: 18px; padding-top: 16px; border-top: 1px solid var(--rim);
  }
  .tkt.selected .tkt__stepper-row { display: flex; }
  .tkt.sold-out  .tkt__stepper-row { display: none; }

  .stepper-label {
    font-size: .65rem; color: var(--muted); font-weight: 600;
    letter-spacing: .08em; text-transform: uppercase; font-family: 'Space Mono', monospace;
  }
  ...
  .stepper-btn--minus { background: rgba(255,255,255,.08); color: #fff; }
  .stepper-btn--minus:hover { background: rgba(255,255,255,.15); }
  .stepper-btn--plus  { background: var(--accent); color: #fff; }
  .stepper-btn--plus:hover { background: #0ea5e9; box-shadow: 0 0 16px rgba(56,189,248,.4); }
  .stepper-num { width: 40px; text-align: center; font-weight: 700; font-size: 1.1rem; color: #fff; font-family: 'Space Mono', monospace; }

  /* ─── BOTTOM BAR ─── */
  .bottom-bar {
    position: fixed; bottom: 0; left: 0; right: 0;
    background: rgba(8,7,15,.95); backdrop-filter: blur(20px) saturate(1.5);
  ...
  .bottom-bar__total {
    font-family: 'Bebas Neue', sans-serif;
    font-size: 2rem; color: #fff; line-height: 1; letter-spacing: .04em;
  }
  .bottom-bar__total-accent { color: var(--accent); }
  ...
  .buy-btn {
    ...
    transition: all .2s; box-shadow: 0 4px 28px rgba(56,189,248,.3); white-space: nowrap;
  }
  .buy-btn:hover { background: #0ea5e9; transform: translateY(-2px); box-shadow: 0 8px 36px rgba(56,189,248,.45); }
  ...
  .modal__handle {
    width: 44px; height: 4px; background: rgba(255,255,255,.12);
    border-radius: 99px; margin: 14px auto 0;
  }
  .modal__head {
    padding: 22px 28px; border-bottom: 1px solid var(--rim);
    display: flex; align-items: flex-start; justify-content: space-between;
  }
  .modal__head-text h3 {
    font-family: 'Bebas Neue', sans-serif;
    font-size: 2rem; letter-spacing: .06em; color: #fff; line-height: 1;
  }
  .modal__head-text p { font-size: .78rem; color: var(--muted); margin-top: 4px; }
  .modal__close {
  ...
  .modal__event-name { font-weight: 700; font-size: 1rem; color: #fff; margin-bottom: 4px; }
  .modal__event-meta { font-size: .78rem; color: var(--muted2); }
  ...
  .modal__stat-label {
    ...
    letter-spacing: .1em; font-family: 'Space Mono', monospace; margin-bottom: 4px;
  }
  .modal__stat-val { font-weight: 700; font-size: .95rem; color: #fff; }
  .modal__total-row {
  ...
  .modal__total-label {
    font-size: .68rem; color: var(--muted2); text-transform: uppercase;
    letter-spacing: .1em; font-family: 'Space Mono', monospace;
  }
  .modal__total-val {
    font-family: 'Bebas Neue', sans-serif;
    font-size: 2.2rem; color: var(--accent); letter-spacing: .04em; line-height: 1;
  }
  ...
  .form-group label {
    ...
    color: var(--muted); margin-bottom: 7px; font-family: 'Space Mono', monospace;
  }
  .form-group input {
    width: 100%; background: rgba(255,255,255,.05); border: 1px solid var(--rim2);
    border-radius: 12px; padding: 13px 16px;
    color: #fff; font-family: 'Outfit', sans-serif; font-size: .92rem;
    outline: none; transition: border-color .2s, box-shadow .2s;
  }
  .form-group input:focus { border-color: rgba(56,189,248,.4); box-shadow: 0 0 0 3px rgba(56,189,248,.08); }
  ...
  .modal__cta:hover { background: #0ea5e9; box-shadow: 0 8px 36px rgba(56,189,248,.4); transform: translateY(-1px); }
  .modal__note { text-align: center; font-size: .68rem; color: var(--muted); margin-top: 14px; padding-bottom: 4px; }

  /* ─── LIGHTBOX ─── */
  .lightbox {
    display: none; position: fixed; inset: 0;
    background: rgba(0,0,0,.96); z-index: 300;
  ...
  .lightbox img { max-width: 100%; max-height: 90svh; border-radius: 16px; object-fit: contain; }

  /* ─── NOT FOUND ─── */
  .not-found { text-align: center; padding: 80px 20px; color: var(--muted); }
  .not-found h2 {
    font-family: 'Bebas Neue', sans-serif;
    font-size: 3rem; color: var(--red); margin: 16px 0 8px; letter-spacing: .05em;
  }
  ...
  @media (min-width: 768px) {
    .wrap { max-width: 1160px; padding: 0 32px 120px; }
  ...
  @media (min-width: 700px) {
    .hero__content { padding: 60px 48px; }
    .bottom-bar { padding: 18px 32px 22px; }
  }
  </style>
          ...
          @foreach ($event->artists as $artist)
            <div class="lineup-card {{ $loop->first ? 'featured' : '' }}">
              @if ($artist->photo ?? null)
                <img class="lineup-card__img" src="{{ asset('images/artists/' . $artist->photo) }}" alt="{{ $artist->name }}">
              @else
                <div class="lineup-card__img-placeholder">
                  <svg width="40" height="40" fill="none" stroke="rgba(56,189,248,.25)" viewBox="0 0 24 24">
              ...
              <div class="lineup-card__body">
                ...
                <div class="lineup-card__role role--{{ Str::slug($artist->role ?? 'headliner') }}">{{ $artist->role ?? 'Headliner' }}</div>
      ...
      <div class="two-col">
          ...
          <div class="about-card fade-up">
            ...
            <div id="editor-wrap">
              ...
              <div style="display:flex;gap:10px;margin-top:12px;">
                <button onclick="saveDescription()" style="background:var(--accent);color:#fff;border:none;border-radius:10px;padding:9px 20px;font-family:'Bebas Neue',sans-serif;font-size:1rem;letter-spacing:.08em;cursor:pointer;">Save</button>
                <button onclick="cancelEdit()" style="background:rgba(255,255,255,.07);color:#fff;border:1px solid var(--rim);border-radius:10px;padding:9px 20px;font-family:'Bebas Neue',sans-serif;font-size:1rem;letter-spacing:.08em;cursor:pointer;">Cancel</button>
              </div>
            </div>
        ...
        <div class="col-right">
          ...
          @if ($event->seat_plan)
            ...
            <div class="seat-chart-wrap fade-up" onclick="document.getElementById('lightbox').classList.add('open')">
            ...
            <div class="ticket-cards" id="ticketList">
              @foreach ($event->tickets as $i => $ticket)
                ...
                >
                  ...
                  <div class="tkt__top">
                    <div>
                      <div class="tkt__name" style="color: {{ $color['hex'] }};">{{ $tktName }}</div>
                  ...
                  @else
                    <div class="tkt__avail" style="color: {{ $color['hex'] }};">
                      <div class="avail-dot" style="background: {{ $color['hex'] }}; box-shadow: 0 0 7px {{ $color['hex'] }};"></div>
                      Available
                    </div>
                  @endif
    ...
    <div class="modal-overlay" id="purchaseModal">
      <div class="modal">
        ...
        <div class="modal__body">
          <div class="modal__event-card">
            <div class="modal__event-name">{{ $event->event_name }}</div>
            <div class="modal__event-meta">
              @if ($event->event_date)
          ...
          <div class="modal__summary-grid">
            <div class="modal__stat">
              <div class="modal__stat-label">Ticket Type</div>
              <div class="modal__stat-val" id="modalType">—</div>
            </div>
            <div class="modal__stat">
              <div class="modal__stat-label">Quantity</div>
              <div class="modal__stat-val" id="modalQty">—</div>
            </div>
            <div class="modal__stat">
              <div class="modal__stat-label">Unit Price</div>
              <div class="modal__stat-val" id="modalUnit">—</div>
            </div>
          </div>

          <div class="modal__total-row">
            <div class="modal__total-label">Total Due</div>
            <div class="modal__total-val" id="modalTotal">₱0</div>
          </div>

          <div class="form-group">
            <label>Full Name</label>
            <input type="text" id="buyerName" placeholder="Juan dela Cruz" autocomplete="name">
          </div>
          <div class="form-group">
            <label>Email Address</label>
            <input type="email" id="buyerEmail" placeholder="juan@example.com" autocomplete="email">
          </div>
          <div class="form-group">
            <label>Phone Number</label>
            <input type="tel" id="buyerPhone" placeholder="+63 9xx xxx xxxx" autocomplete="tel">
          </div>

          <button class="modal__cta" onclick="submitPurchase()">
            Confirm &amp; Pay
            <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/>
            </svg>
          </button>
          <p class="modal__note">Your ticket will be sent to your email after payment.</p>
        </div>
      </div>
    </div>
  ...
  @else
    ...
    <div class="wrap">
      <div class="not-found">
        <svg width="64" height="64" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color:var(--red);opacity:.5;display:block;margin:0 auto;">
  ...
  <script>
  let selPrice = 0, selName = '', selQty = 1, selMaxQty = 1;
  ...
  function selectTicket(el) {
    ...
    document.querySelectorAll('.tkt').forEach(t => {
      ...
      if (n) { n.textContent = 1; n.dataset.qty = 1; }
    });
    ...
    if (n) { n.textContent = selQty; n.dataset.qty = selQty; }
    updateBar();
  }
  ...
  function toggleEditor() {
    ...
    if (wrap.style.display === 'block') { cancelEdit(); return; }
    wrap.style.display = 'block'; disp.style.display = 'none'; btn.textContent = 'Cancel';
    if (!quill) {
