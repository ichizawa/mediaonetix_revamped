            ...
            <div class="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center justify-items-center">
                ...
                <div
                    ...
                    <div
                        ...
                        <span class="text-blue-300 text-xs sm:text-sm font-medium" id="event-category">SUMMER FEST
                            2024</span>
                    </div>
                    ...
                    <div class="event-title w-full">
                        <h1
                            class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-tight text-white mb-4 sm:mb-6">
                    ...
                    <div class="event-details space-y-3 sm:space-y-4 mb-6 sm:mb-8 w-full">
                        <div class="flex items-center gap-3 sm:gap-4 text-gray-300">
                            ...
                            <span class="text-base sm:text-lg font-semibold" id="event-date">August 15, 2024</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 sm:gap-4 text-gray-300">
                            ...
                            <span class="text-base sm:text-lg font-semibold" id="event-venue">City Arena</span>
                        </div>
                        ...
                        <div class="flex items-center gap-3 sm:gap-4">
                            ...
                            <span class="text-3xl sm:text-4xl font-bold text-blue-400" id="event-price">$89</span>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="poster-container relative w-full h-[70vh] sm:h-[75vh] lg:h-[80vh]">
                        ...
                        <div class="relative h-full w-full group">
                            <!-- Main Poster -->
                            <div
                                class="poster-main relative h-full w-full overflow-hidden rounded-2xl sm:rounded-3xl border-2 sm:border-4 border-blue-500/30 shadow-2xl shadow-blue-500/20 transition-all duration-500 group-hover:border-blue-500/50 group-hover:shadow-blue-500/30">
                                <div
                                    class="h-full w-full bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-500 flex flex-col items-center justify-between relative overflow-hidden p-6 sm:p-8 lg:p-12">
                                    ...
                                    <div class="relative z-10 w-full text-center flex-shrink-0">
                                        <div
                                            class="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-white/20 backdrop-blur-xl rounded-full border-2 border-white/30">
                                            <span class="text-white font-bold text-xs sm:text-sm lg:text-base"
                                    ...
                                    <div
                                        class="relative z-10 text-center flex-1 flex flex-col justify-center items-center py-6">
                                        <h2
                                            class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white mb-2 sm:mb-3 drop-shadow-lg poster-title-1">
                                            ELECTRONIC</h2>
                                        <h2
                                            class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-white drop-shadow-lg poster-title-2">
                                            PARADISE</h2>
                                    </div>
                                    ...
                                    <div class="relative z-10 w-full space-y-3 sm:space-y-4 flex-shrink-0">
                                        <div
                                            ...
                                            <div class="flex items-center justify-between">
                                                <span
                                                    class="text-white/80 font-medium text-sm sm:text-base lg:text-lg">Starting
                                                    from</span>
                                                <span
                                                    class="text-3xl sm:text-4xl lg:text-5xl font-black text-white poster-price"
