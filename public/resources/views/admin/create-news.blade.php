        ...
        <div class="row">
                ...
                <div class="card shadow-sm rounded-3 mb-4">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div id="quill-toolbar"
                            class="ql-toolbar ql-snow px-3 py-2 rounded-top border-bottom bg-light d-flex flex-wrap gap-2 sticky-top"
                            style="z-index: 1;">
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm rounded-3 mb-4">
                    ...
                    <div class="card-body p-4">
                        <div class="border-dashed rounded-3 p-4 text-center bg-light mb-3" style="cursor: pointer;"
                            ...
                            <input type="file" class="d-none" accept="image/*" id="image-input"
                                onchange="previewImage(event)">
                        </div>
                        <div class="mb-3 d-flex justify-content-center">
                            <button class="btn btn-sm btn-outline-danger d-none" id="remove-btn"
