                    ...
                    <div class="container my-5">
                        ...
                        <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="display-name" name="username"
                                    placeholder="Enter display name" value="{{ Auth::user()->username }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="position-relative">
                                    ...
                                    <i class="bi bi-eye-fill position-absolute"
                                        style="right: 15px; top: 50%; transform: translateY(-50%); color: #6c757d; cursor: pointer;"></i>
                                </div>
                            </div>
