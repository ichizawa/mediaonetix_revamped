                            ...
                            <div class="row d-flex flex-column align-items-start grid gap-2">
                                ...
                                <div class="col-sm-12 d-flex align-items-center justify-content-between mt--2">
                                    <div class="d-flex align-items-center w-75">
                                        ...
                                        <span
                                            class="fw-bold me-2 text-truncate d-inline-block w-100 overflow-hidden text-nowrap"
                                    ...
                                    <div class="d-flex align-items-center gap-1">
                                        <button
                                            onclick="window.location.href = '{{ route('admin.events.view', $event->slug) }}'"
                                            class="btn btn-sm p-1">
                                            <i class="fa fa-edit fs-5"></i>
                                        </button>
                                        <button class="btn btn-sm text-danger p-1 delete-event"
                                            data-id="{{ $event->id }}">
                    ...
                    if (willDelete) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $.notify({
                                    icon: 'fa fa-bell',
                                    title: response.code == 200 ? 'Success' :
                                        'Error',
