<form method="POST" action="{{ route('merchant.announcements.create') }}" enctype="multipart/form-data">
    @csrf
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="updateAnnouncementSidePanel"
        aria-labelledby="updateAnnouncementSidePanel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title fw-bold" id="updateAnnouncementSidePanel">Update Announcement</h5>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="d-flex justify-content-between grid gap-3">
                            <button type="submit" class="btn btn-sta w-50 fw-bold">Update Announcement</button>
