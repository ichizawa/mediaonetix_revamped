...
@section('content')
    ...
    @include('components.update-announcement')
                ...
                <div class="card w-100 d-flex">
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex justify-content-between">
                            ...
                            <a data-bs-toggle="offcanvas" data-id="{{ $event->slug }}" class="btn btn-warning btn-sm rounded edit-event"
                                href="#updateEventSidePanel">
                    ...
                    <div class="m-4">
                        ...
                        <div class="gap-5">
                            <div style="max-height: 350px; overflow-y: auto;">
                                @foreach ($event->announcement as $announcements)
                                    <div class="container bg-light p-4 rounded border mb-3 d-flex align-items-center">
                                        <div class="w-75">
                                        ...
                                        <div class="ms-auto">
                                            <a data-bs-toggle="offcanvas" class="btn btn-warning btn-sm rounded" data-id="${row.id}" href="#updateAnnouncementSidePanel">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        </div>
                                    </div>
                            ...
                            <div class="container bg-light p-4 rounded border text-center create-announcement" data-id="{{ $event->id }}" data-bs-toggle="offcanvas"
    ...
    <script>
        $(document).ready(function () {
            const tableTicket = $('#basic-datatables').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: "{{ route('merchant.tickets.view', $id) }}",
                    type: "GET",
                    dataType: "json",
                    dataSrc: "",
                },
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                                    <a data-bs-toggle="offcanvas" class="btn btn-warning btn-sm rounded edit-ticket" data-id="${row.id}" href="#editTicketSidePanel">
                                        <i class="fa fa-edit"></i>
                                    </a>
            ...
            $(document).on('click', '.delete-ticket', function () {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            url: "{{ route('merchant.delete.ticket') }}",
                            type: "DELETE",
                            data: {
                                id: id,
                                _token: "{{ csrf_token() }}"
